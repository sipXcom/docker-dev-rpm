...
if [ "$1" = 'init' ]; then
    ...
    sudo ../configure --enable-rpm UPSTREAM_URL=$2 CENTOS_RSYNC_URL=rsync://download.sipxcom.org/pub MIRROR_SITE=http://download.sipxcom.org/pub PACKAGE_REVISION=stable
